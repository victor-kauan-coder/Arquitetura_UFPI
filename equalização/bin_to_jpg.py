...
imagem_final = substituir_canais_rgb(
    imagem_original,
    os.path.join(base_dir,"bins/pixel_bytes_red.bin"),
    os.path.join(base_dir,"bins/pixel_bytes_green.bin"),
    os.path.join(base_dir,"bins/pixel_bytes_blue.bin")
)
...
fig.show()
imagem_final.save("imagens/imagem_equalizada_assembly.jpg")
